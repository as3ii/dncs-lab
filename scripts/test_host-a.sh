...
check "10.0.4.1" && printf "[$OK]\n" || printf "[$FAILED]\n"
# 10.0.2.0/23 should not be reachable from subnets different from 10.0.0.0/23
check "10.0.2.1" && printf "[$FAILED]\n" || printf "[$OK]\n"
check "10.0.2.2" && printf "[$FAILED]\n" || printf "[$OK]\n"
